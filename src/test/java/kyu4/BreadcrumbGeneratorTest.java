...
public class BreadcrumbGeneratorTest {
    ...
    public void examplesTests() {
        ...
        String[] urls = new String[] {"mysite.com/pictures/holidays.html",
                ...
                "facebook.fr/issues/surfer-the-with-in-and-skin-research/login.html#conclusion"};
        ...
        String[] anss = new String[] {"<a href=\"/\">HOME</a> : <a href=\"/pictures/\">PICTURES</a> : <span class=\"active\">HOLIDAYS</span>",
                ...
                "<a href=\"/\">HOME</a> >>> <a href=\"/issues/\">ISSUES</a> >>> <a href=\"/issues/surfer-the-with-in-and-skin-research/\">SSR</a> >>> <span class=\"active\">LOGIN</span>"};
